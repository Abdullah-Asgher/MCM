                ...
                <div className="ps-section__wrapper">
                    ...
                    <div className="ps-section__right">
                        <figure className="ps-section__desc">
                            ...
                            <p>
                                MartFury Buyer Protection has you covered from
                                click to delivery. Sign up or sign in and you
                                will be able to:
                            </p>
                        ...
                        <div className="ps-section__coupon">
                            ...
                            <aside>
                                ...
                                <p>
                                    Martfury give $25 as a small gift for your
                                    first purchase. Welcome to Martfury!
                                </p>
                            </aside>
                        </div>
                    </div>
