...
const HeaderActions = () => {
    ...
    return (
        <div className="header__actions" >
            <Link href="/account/compare" className="header__extra" style={{color: "#fff"}}>
                <i className="icon-chart-bars" />
                <span style={{background: "#fff"}}>
                    <i style={{color: "#000"}}>{compareItems ? compareItems.length : 0}</i>
                </span>
            </Link>
            <Link href="/account/wishlist" className="header__extra" style={{color: "#fff"}}>
                <i className="icon-heart" />
                <span style={{background: "#fff"}}>
                    <i style={{color: "#000"}}>{wishlistItems ? wishlistItems.length : 0}</i>
                </span>
            </Link>
            <MiniCart />
            {headerAuthContent}
